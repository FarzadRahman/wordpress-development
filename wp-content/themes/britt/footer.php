...
?>
	...
	<footer id="colophon" class="site-footer" role="contentinfo">
		...
		<div class="container info-wrapper">	
			<div class="site-info">
				<a href="<?php echo esc_url( __( 'https://wordpress.org/', 'britt' ) ); ?>"><?php printf( esc_html__( 'Powered by %s', 'britt' ), 'WordPress' ); ?></a>
				<span class="sep"> | </span>
				<?php printf( esc_html__( 'Theme: %2$s by %1$s', 'britt' ), 'theme.blue', '<a href="http://theme.blue/themes/britt/" rel="designer">Britt</a>' ); ?>
			</div><!-- .site-info -->
		</div>
	</footer><!-- #colophon -->
</div><!-- #page -->
